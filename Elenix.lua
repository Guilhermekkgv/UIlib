...
function LinuxLib.Tab(config)
    ...
    local function SelectTab()
        -- Só anima se estiver trocando de aba (não clicando na mesma aba)
        ...
        -- Animação de fade-in apenas quando trocar de aba
        ...
        for _, child in pairs(Container:GetChildren()) do
            if child:IsA("Frame") then
                -- Preservar transparência original dos elementos que devem ser transparentes
                local originalBgTransparency = 0
                if child.Name == "Section" then
                    originalBgTransparency = 1 -- Section deve permanecer transparente
                end
